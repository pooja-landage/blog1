...
<table class="table table-striped">
  ...
  @foreach($data as $d)
    ...
    <th>
      ...
      <td>{{$d->title}}</td>
      <td>{{$d->description}}</td>
     <td> <img src="/images/{{ $d->image}}" onerror="this.src='http://127.0.0.1:8000/images/sample%20plan%202%203d%20exteroir.jpg'"  width="50px" height="50px"> </td>

      <td><a href={{route('product.form.edit',$d->id)}}>Edit</a>
        <a href={{route('product.form.delete',$d->id)}} onclick="alert('Successfully Deleted!')">Delete</a></td>  
      </tr>

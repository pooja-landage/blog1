                        ...
                        @foreach ($all as $all)
                            ...
                            <div class="col-md-6">
                                <div class="tn-img">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{route('admin.shop.category.update', $info->id)}}">{{$all->title}}</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                ...
                                <div class="tn-title">
                                    <a href="{{route('product.info')}}">{{$all->title}}</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                    ...
                    <div class="row cn-slider">
                        ...
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="images/{{$all->image}}" width="350px" height="223px"/ >
                                <div class="cn-title">
                                    <a href="{{route('product.info')}}">{{$all->title}}</a>
                                </div>
                            </div>
                        ...
                        <div class="tab-content">
                            <div id="featured" class="container tab-pane active">
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{route('product.info')}}">Lorem ipsum dolor sit amet</a>
                                    </div>
                                </div>
                                <div class="tn-news">
                                    <div class="tn-img">
